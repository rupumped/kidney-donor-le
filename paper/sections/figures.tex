...
\begin{figure}[ht]
	...
	\caption{\textbf{Life-expectancy impact of kidney donation by age, race, and sex.} Each cell shows $\Delta\text{LE}$ (donor minus non-donor, days) for the indicated sex panel, race row, and age-at-donation column. Age at donation dominates: a Black male donor at age~25 loses 1{,}507~days, compared with 619~days for a White female donor at age~55. Racial and sex differences within an age group are comparatively small: at age~25, the largest within-age contrast (Black male vs.\ White female) is 1{,}507 vs.\ 1{,}048~days, a 44\% difference.}
...
\begin{figure}[ht]
	\centering
	\includegraphics[width=\linewidth]{figures/kidney_model_F_hr_scenarios.png}
	\caption{\textbf{Structural sensitivity to the donor all-cause mortality HR.} Each bar shows the $\Delta\text{LE}$ resulting from replacing the base-case time-varying HR profile (1.0 flat through year~10, ramping to 1.30 by year~15) with a single flat HR held for the donor's entire remaining lifetime, taken from an individual published estimate. Vertical dashed line marks zero. The choice of HR assumption spans a 3{,}550-day range, from a multi-year life-expectancy benefit (HR~$=0.60$, O'Keeffe et~al.\ pooled estimate) to a cost exceeding four years (HR~$=1.52$, upper bound of the Mjøen et~al.\ 95\%~CI), dwarfing every other source of uncertainty examined in this analysis.}
